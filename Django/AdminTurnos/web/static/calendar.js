let VanillaCalendar = function() {
    return function(t) {
        ...
        let n = {
            ...
            month_label: null,
            onSelect: (t, e) => {},
            months: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciemnbre"],
            shortWeekday: ["Do", "Lu", "Ma", "Mi", "Ju", "Vi", "Sa"]
        };
        ...
        const d = function(t) {
                ...
                e.setAttribute("data-calendar-date", t.getDate());
                e.setAttribute("data-calendar-month", t.getMonth());
                e.setAttribute("data-calendar-year", t.getFullYear());
                ...
                let d = n.availableDates.filter(e => e.date === t.getFullYear() + "-" + String(t.getMonth() + 1).padStart("2", 0) + "-" + String(t.getDate()).padStart("2", 0));

                if(1 === t.getDate()) (e.style.marginLeft = 14.28 * t.getDay() + "%");
                        ...
                        : 
                               (e.classList.add("vanilla-calendar-date--active"),
                                ...
                                t.toString() === n.todaysDate.toString() &&
                                       ...
                                       e.appendChild(a), n.month.appendChild(e)
        ...
        r = function() {
                l.querySelectorAll("[data-calendar-status=active]").forEach(t => {
                    t.addEventListener("click", function() {
                        ...
                        if (t.calendarDate){ 
                                e.date = t.calendarDate;
                                e.month = t.calendarMonth;
                                e.year = t.calendarYear;
                        };

                        if (t.calendarData) (e.data = JSON.parse(t.calendarData));
        ...
        s = function() {
                ...
                for (; n.date.getMonth() === t;){
                        d(n.date);
                        n.date.setDate(n.date.getDate() + 1);
                }

                n.date.setDate(1);
                n.date.setMonth(n.date.getMonth() - 1);
                n.month_label.innerHTML = n.months[n.date.getMonth()] + " " + n.date.getFullYear();
                r()
        };
